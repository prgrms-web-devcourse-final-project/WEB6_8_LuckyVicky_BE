package com.back.domain.faq.controller;
...
public class FaqControllerTest {
    ...
    void t1() throws Exception {
        ...
        // when
        ResultActions resultActions = mvc.perform(get("/api/faqs")
                        .param("page", "1")
                        .param("size", "10")
    ...
    void t4() throws Exception {
        ...
        // when
        ResultActions resultActions = mvc.perform(get("/api/faqs/" + faq.getId())
                        .contentType(MediaType.APPLICATION_JSON))
                .andDo(print());
    ...
    void t5() throws Exception {
        // when
        ResultActions resultActions = mvc.perform(get("/api/faqs/99999")
                        .contentType(MediaType.APPLICATION_JSON))
                .andDo(print());
    ...
    void t6() throws Exception {
        ...
        // when
        ResultActions resultActions = mvc.perform(post("/api/faqs")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void t10() throws Exception {
        ...
        // when
        ResultActions resultActions = mvc.perform(put("/api/faqs/" + faq.getId())
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(requestBody)))
                .andDo(print());
    ...
    void t11() throws Exception {
        ...
        // when
        ResultActions resultActions = mvc.perform(put("/api/faqs/99999")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(requestBody)))
                .andDo(print());
    ...
    void t12() throws Exception {
        ...
        // when
        ResultActions resultActions = mvc.perform(delete("/api/faqs/" + faq.getId())
                        .contentType(MediaType.APPLICATION_JSON))
                .andDo(print());
    ...
    void t13() throws Exception {
        // when
        ResultActions resultActions = mvc.perform(delete("/api/faqs/99999")
                        .contentType(MediaType.APPLICATION_JSON))
                .andDo(print());
    ...
    void t15() throws Exception {
        // when
        ResultActions resultActions = mvc.perform(delete("/api/faqs/1")
                        .contentType(MediaType.APPLICATION_JSON))
                .andDo(print());

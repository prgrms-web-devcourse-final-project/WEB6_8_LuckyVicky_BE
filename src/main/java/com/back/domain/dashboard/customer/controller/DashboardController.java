...
public class DashboardController {
     ...
     * 주문 상태별, 애프터세일즈 상태별 필터링과 기간별 검색이 가능합니다.
     * 
     * @param authorization Bearer 토큰 (필수)
     * @param page 페이지 번호 (0부터 시작, 기본값: 0)
     * @param size 페이지 크기 (1-100, 기본값: 10)
     * @param status 주문 상태 필터 (PENDING, CONFIRMED, PREPARING, SHIPPED, DELIVERED, CANCELED 중 선택)
     * @param aftersalesStatus 애프터세일즈 상태 필터 (CANCEL_REQUESTED, CANCEL_PROCESSING, CANCEL_COMPLETED, EXCHANGE_REQUESTED, EXCHANGE_PROCESSING, EXCHANGE_COMPLETED 중 선택)

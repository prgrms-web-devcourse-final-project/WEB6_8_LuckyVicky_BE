...
echo "REDIS_HOST=redis_1" >> /etc/environment
echo "REDIS_PASSWORD=${var.password}" >> /etc/environment
echo "DB_HOST=${aws_db_instance.rds_postgres.address}" >> /etc/environment
